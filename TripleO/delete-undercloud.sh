yum autoremove openstack-* instack* mariadb* *heat* *director* mongodb* rabbitmq-server httpd* python-swift haproxy memcached docker* puppet
...
/home/stack/stackrc /root/stackrc /home/stack/undercloud-passwords.conf /etc/puppet /var/lib/docker

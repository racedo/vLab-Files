...
/etc/glance /etc/haproxy /etc/heat /etc/httpd /etc/ironic-inspector /etc/mistral /etc/neutron /etc/nova /etc/rabbitmq /etc/swift /etc/tempest /etc/zaqar /httpboot /tftpboot
